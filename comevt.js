...
function cardCreator(name,desc,link){
    ...
    <div class="card-content" style="overflow: scroll; overflow-x: hidden;">
    <a class="btn-floating halfway-fab waves-effect waves-light red " style="z-index: 1" ><i class="material-icons";>add</i></a>
        <p>${desc}</p>
    </div>
  </div>
  </div>`;
